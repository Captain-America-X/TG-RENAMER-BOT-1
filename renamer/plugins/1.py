...
async def force_sub(c, m):
    if Config.FORCE_SUB:
        try:
            ...
            logger.error(e)
            return await m.reply_text("Some thing went wrong. Try again and if same issue occur contact [our group](https://t.me/Captain_Aerica_X)", disable_web_page_preview=True, quote=True)
